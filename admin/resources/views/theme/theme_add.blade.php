    ...
    <form class="layui-form" action="" id="form-theme-add" enctype="multipart/form-data" method="get">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" id="name" required  lay-verify="required" placeholder="请输入主题名" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="deposit" id="deposit" required  lay-verify="required" placeholder="请输入定金" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            function () {
                ...
                form.on('submit(formSave)', function(data){
                    ...
                    layer.alert("添加成功", {
                        ...
                        window.location.href = "{{url('/admin/theme')}}";
                    });
                    // return false;
                });
            });
