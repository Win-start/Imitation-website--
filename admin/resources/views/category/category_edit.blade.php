...
@section('content')
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" id="name" required  lay-verify="required" value="{{$category->category_name}}" autocomplete="off" class="layui-input">
        </div>
    </div>
        <div class="layui-form-item">
            <label class="layui-form-label">图片</label>
            <div class="layui-input-block">
                <img class="layui-upload-img" width="100" height="100" id="demo1" src="{{$category->image}}">
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            <input type="hidden" id="id" name="id" value="{{$category->category_id}}">
